...
bed_level_pattern_type =
    is_num(selected_pattern_type)
        ? pattern_names[(selected_pattern_type >= 0 && selected_pattern_type <= 7) ? selected_pattern_type : 0]
...
if (bed_level_pattern_type == "concentric squares" || bed_level_pattern_type == "spiral squares" ||
...
generate_bed_level_pattern(bed_level_pattern_type = bed_level_pattern_type, print_area_width = print_area_width,
